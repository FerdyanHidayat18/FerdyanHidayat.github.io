        ...
        <div class="section2">
            <div class="matkul col-12" style="padding: 0">
                <div class="d-flex justify-content-between">
                    ...
                    <a href="form-materi.php?id=<?php echo $id_jadwal ?>" style="font-size: 15px;" class="n-underline text-darkblue d-flex align-items-center">
                        <i class="ri-add-line"></i> Upload Materi Baru
                    </a>
                </div>
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_array()) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="detail-materi.php?id=<?php echo $id_jadwal ?>&id_materi=<?php echo $row['id_materi'] ?>" class="text-blue">Detail</a> | <a href="aksi/aksi-delete.php?hapus=materi&id=<?php echo $row['id_materi']; ?>&id_jadwal=<?php echo $id_jadwal ?>" class="text-red">Hapus</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
